...
def extract_recommendation_intent(query: str, anime_list: list) -> dict:
    ...
    prompt_template = get_prompt("recommendation_intent")

    messages = [
        {
            "role": "system",
            "content": prompt_template.render_system(
                anime_list=anime_list_str,
            ),
        },
        {
            "role": "user",
            "content": prompt_template.render(query=query),
        },
    ]
...
def _llm_description_with_search(anime_name: str) -> str:
    ...
    messages = [
        ...
        {
            "role": "user",
            "content": prompt_template.render(anime_name=anime_name),
        },
    ]
