...
RECOMMEND_PROMPT_MAX_CHARS = _get_int_env("RECOMMEND_PROMPT_MAX_CHARS", 16000)
RECOMMEND_PROMPT_MAX_TOKENS = _get_int_env("RECOMMEND_PROMPT_MAX_TOKENS", 10000)
RECOMMEND_MEMORY_CONTEXT_MAX_CHARS = _get_int_env(
    "RECOMMEND_MEMORY_CONTEXT_MAX_CHARS",
    6000,
)
# 会话摘要只在两个条件同时满足时更新；原始消息始终保留在业务库中。
RECOMMEND_MEMORY_SUMMARY_MIN_MESSAGES = 6
RECOMMEND_MEMORY_SUMMARY_MIN_CHARS = 4000
