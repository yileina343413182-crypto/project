    ...
    <div class="auth-card">
      ...
      <div class="auth-logo">
        ...
        <div class="auth-logo-text">
          ...
          <span class="auth-welcome">欢迎回来</span>
        </div>
      </div>
...
.auth-overlay {
  ...
  background: linear-gradient(
    135deg,
    rgba(0, 0, 0, 0.68) 0%,
    rgba(3, 10, 22, 0.78) 50%,
    rgba(0, 15, 35, 0.7) 100%
  );
}
...
.auth-avatar {
  ...
  box-shadow: 0 0 16px rgba(0, 229, 255, 0.35), 0 0 40px rgba(0, 229, 255, 0.1);
}
...
.auth-input:focus {
  ...
  box-shadow: 0 0 0 3px rgba(0, 229, 255, 0.06), 0 0 16px rgba(0, 229, 255, 0.1);
...
.pwd-toggle:hover { color: rgba(0, 229, 255, 0.8); }
...
.auth-btn {
  ...
  border-radius: 10px;
  border: none;
  background: linear-gradient(135deg, #00b8d9 0%, #00e5ff 50%, #00c8e8 100%);
  color: #020d18;
  font-size: 15px;
  font-weight: 800;
  letter-spacing: 3px;
...
.auth-btn:not(:disabled):hover {
  ...
  box-shadow: 0 8px 32px rgba(0, 229, 255, 0.45), 0 0 60px rgba(0, 229, 255, 0.15);
  background: linear-gradient(135deg, #00ccee 0%, #00f0ff 50%, #00daf0 100%);
}
